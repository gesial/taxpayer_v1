...
import TaxPayerTestNG.positiveTest.name;
...
public class negativeTest_ubah_profil {
  ...
  public void init_state() {
    ...
    driver.findElement(By.id("form-signup")).clear();
    
    WebElement email = driver.findElement(By.xpath("//*[@id=\"form-signup\"]/div[3]/div/input")); //.findElement(By.name(name.hp));
